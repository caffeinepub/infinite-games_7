...
function ParticleCanvas({ dark }) {
  ...
  reactExports.useEffect(() => {
    ...
    const colors = dark ? ["#34E6FF", "#A855FF", "#3A7BFF", "#C13CFF"] : ["#3A7BFF", "#A855FF", "#20CFFF"];
    const count2 = 80;
    const particles = Array.from({ length: count2 }, () => ({
      x: Math.random() * width,
      ...
      for (let i = 0; i < count2; i++) {
        for (let j = i + 1; j < count2; j++) {
          ...
          if (dist < 120) {
            ...
            ctx.strokeStyle = dark ? `rgba(52, 230, 255, ${alpha})` : `rgba(58, 123, 255, ${alpha})`;
            ctx.lineWidth = 0.8;
            ctx.stroke();
          }
        }
      ...
      ` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              height: 260,
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(168,85,255,0.22) 0%, rgba(52,230,255,0.12) 50%, transparent 70%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              boxShadow: "0 0 18px rgba(52,230,255,0.5), inset 0 0 12px rgba(168,85,255,0.3)",
              marginBottom: 32,
              position: "relative",
              zIndex: 1
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "This can take a while"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        ...
                        width: `${progress}%`,
                        borderRadius: 999,
                        background: "linear-gradient(90deg, #3A7BFF 0%, #34E6FF 40%, #A855FF 100%)",
                        backgroundSize: "200% 100%",
                        animation: "progressShimmer 1.8s linear infinite",
                        boxShadow: "0 0 10px rgba(52,230,255,0.7), 0 0 4px rgba(168,85,255,0.5)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8, position: "relative", zIndex: 1 }, children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
              width: 7,
...
function GameCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      type: "button",
      "data-ocid": wide ? `recent.item.${index2}` : `games.item.${index2}`,
      className: `group relative rounded-xl border bg-card overflow-hidden cursor-pointer transition-all duration-200 text-left ${wide ? "flex gap-3 p-2" : "flex flex-col w-full"}`,
      onClick: () => onPlay(game),
      onMouseEnter: () => setHovered(true),
      onMouseLeave: () => setHovered(false),
      style: {
        borderColor: hovered ? "rgba(52,230,255,0.55)" : "rgba(52,230,255,0.3)",
        boxShadow: hovered ? "0 0 18px rgba(52,230,255,0.22), 0 0 6px rgba(168,85,255,0.18), 0 2px 12px rgba(52,230,255,0.12)" : "0 2px 12px rgba(52,230,255,0.08), 0 0 1px rgba(168,85,255,0.2)",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `relative overflow-hidden ${wide ? "w-24 h-16 rounded-lg flex-shrink-0" : "w-full aspect-video"}`,
            children: [
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-gradient-to-br from-neon-blue/20 to-neon-purple/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-8 h-8 text-muted-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-8 h-8 text-white drop-shadow-lg" }) })
            ]
          }
        ),
        wide ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground truncate", children: game.name }),
          game.author && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: [
            "by ",
            game.author
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              type: "button",
              "data-ocid": `recent.download_button.${index2}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground truncate mb-0.5", children: game.name }),
          game.author && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
          ...
          !game.author && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              {
                type: "button",
                "data-ocid": `games.download_button.${index2}`,
...
function App() {
  ...
  const [launchMode, setLaunchMode] = reactExports.useState(
    () => localStorage.getItem(LS_LAUNCH_MODE) || "iframe"
  );
  const [cloak, setCloak] = reactExports.useState(
    () => localStorage.getItem(LS_CLOAK) || "google"
  );
  const [games, setGames] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(true);
  const [gameLoading, setGameLoading] = reactExports.useState(false);
  const [search, setSearch] = reactExports.useState("");
  const [recentIds, setRecentIds] = reactExports.useState(() => {
    try {
  ...
  const [panicKeyInput, setPanicKeyInput] = reactExports.useState(
  ...
  reactExports.useEffect(() => {
    fetch("https://cdn.jsdelivr.net/gh/gn-math/assets@main/zones.json").then((r2) => r2.json()).then((data) => {
      setGames(data.filter((z) => z.id >= 0));
    }).catch(console.error).finally(() => setLoading(false));
  }, []);
  const closeIframe = reactExports.useCallback(() => {
    setIframeUrl(null);
    setActiveGame(null);
  }, []);
  ...
  const filteredGames = search.trim() ? games.filter((g) => g.name.toLowerCase().includes(search.toLowerCase())) : games;
  const saveSettings = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen relative overflow-x-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleCanvas, { dark }),
    gameLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(GameLoadingOverlay, {}),
    iframeUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[200] bg-black flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-center justify-between px-4 py-3 border-b border-white/10",
          style: {
            background: "linear-gradient(180deg, rgba(7,10,28,0.98) 0%, rgba(7,10,28,0.92) 100%)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center min-w-0 mr-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: (activeGame == null ? void 0 : activeGame.name) ?? "Game"
                }
              ),
              (activeGame == null ? void 0 : activeGame.author) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "iframe",
        {
          ...
          allow: "fullscreen",
          title: (activeGame == null ? void 0 : activeGame.name) ?? "Game"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        style: {
          background: dark ? "rgba(7, 10, 28, 0.85)" : "rgba(240, 243, 255, 0.85)",
          boxShadow: "0 1px 20px rgba(52,230,255,0.12)"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 max-w-xl items-center gap-2", children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "svg",
                    {
                      ...
                      "aria-hidden": "true",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Discord" }),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "svg",
                    {
                      ...
                      "aria-hidden": "true",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "DuckDuckGo" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "16", r: "16", fill: "#DE5833" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "14", r: "7", fill: "white" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "16", cy: "24", rx: "5", ry: "3", fill: "#F5A623" })
                      ]
                    }
                  ),
                  "Proxy"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-10", children: [
      recentGames.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3", children: recentGames.map((game, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          GameCard,
          {
            game,
            onPlay: handlePlay,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                children: search ? `Results for "${search}"` : "All Games"
              }
            )
          ] }),
          !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
            filteredGames.length,
            " games"
          ] })
        ] }),
        loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3", children: Array.from({ length: 24 }).map((_, i) => i).map((skelId) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
          ...
          `skel-${skelId}`
        )) }) : filteredGames.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": "games.empty_state",
            className: "text-center py-20 text-muted-foreground",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-12 h-12 mx-auto mb-3 opacity-30" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold", children: "No games found" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Try a different search term" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3", children: filteredGames.map((game, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          GameCard,
          {
            game,
            onPlay: handlePlay,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "dark-toggle", className: "text-sm font-medium", children: "Dark Mode" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium", children: "Game Launch Mode" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      borderColor: launchMode === "iframe" ? "#34E6FF" : "rgba(52,230,255,0.2)",
                      color: launchMode === "iframe" ? "#34E6FF" : void 0,
                      background: launchMode === "iframe" ? "rgba(52,230,255,0.08)" : void 0,
                      textShadow: launchMode === "iframe" ? "0 0 8px #34E6FF" : void 0,
                      cursor: "pointer"
                    },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: "flex-1 py-2 px-3 rounded-lg text-xs font-bold uppercase tracking-wider border transition-all",
                    style: {
                      borderColor: launchMode === "blank" ? "#A855FF" : "rgba(168,85,255,0.2)",
                      color: launchMode === "blank" ? "#A855FF" : void 0,
                      background: launchMode === "blank" ? "rgba(168,85,255,0.08)" : void 0,
                      textShadow: launchMode === "blank" ? "0 0 8px #A855FF" : void 0,
                      cursor: "pointer"
                    },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: launchMode === "iframe" ? "Games open fullscreen on this page" : "Games open directly in a new browser tab" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-sm font-medium", children: [
                "Tab Cloak",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-xs text-muted-foreground", children: "(disguise this tab)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: cloakOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  className: "py-2 px-3 rounded-lg text-xs font-semibold border transition-all text-left truncate",
                  style: {
                    borderColor: cloak === opt.value ? "#34E6FF" : "rgba(52,230,255,0.15)",
                    color: cloak === opt.value ? "#34E6FF" : "rgba(200,210,240,0.6)",
                    background: cloak === opt.value ? "rgba(52,230,255,0.08)" : "transparent",
                    textShadow: cloak === opt.value ? "0 0 8px #34E6FF" : void 0,
                    cursor: "pointer"
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "panic-key", className: "text-sm font-medium", children: [
                "Panic Key",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-xs text-muted-foreground", children: "(redirects to Google)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                "Type a key name like ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "Escape" }),
                ", ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "F1" }),
                ", or a letter like ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "g" })
              ] })
            ] })
          ] }),
